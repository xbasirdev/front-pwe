...
export class VerificacionComponent implements OnInit
{
    ...
    edit(id): void {
      this.route.navigate(['/verificacion/edit/' + id])
    }
...
@Component({
    selector     : 'verificacion-graph',
    templateUrl  : './verificacion.graph.component.html',
    styleUrls    : ['./verificacion.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class CuestionarioGraphComponent implements OnInit
{
    ...
    constructor(  public cuestionarioService: VerificacionService,
        private route: Router,
        private router: ActivatedRoute, ) {
        this.chartOptions = {
          series: [
...
@Component({
    selector     : 'verificacion-add',
    templateUrl  : './verificacion.add.component.html',
    styleUrls    : ['./verificacion.component.scss'],
    encapsulation: ViewEncapsulation.None
})
